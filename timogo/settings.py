"""
Django settings for timogo project.
...
import os
# For correcting font awesome dependency
import sys
...
SECRET_KEY = 'django-insecure-ot4akp$h(v6j-k)i6ca6@+41v3t*fc!6t*7stm7-z@40!ekq%o'
